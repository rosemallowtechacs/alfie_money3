...
import 'Home.dart';
class LoanApproedList extends StatefulWidget {
  const LoanApproedList({Key key,this.status}) : super(key: key);
...
class _LoanApprovalState extends State<LoanApproedList> {
