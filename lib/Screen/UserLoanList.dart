...
class UserLoanList extends StatefulWidget {
  @override
  _UserLoanListState createState() => _UserLoanListState();
}

class _UserLoanListState extends State<UserLoanList> {
...
//Text("Loans Availed"),
  ...
  Widget build(BuildContext context) {
    ...
    Text("Number of Loans Taken", style: TextStyle(color: Rmlightblue, fontSize: 18, fontWeight: FontWeight.bold),)
    ),
                          ...
                          child: Container(child:Stack(children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                FittedBox(child:Text("${snapshot.data.data[index].tenure??""} months",style: TextStyle(color: Colors.black,fontSize: 12)) ,
                                  fit:BoxFit.contain,),
                                SizedBox(height: 5,),
                                Text("Repayment History:",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.bold)),
                                FittedBox(child:Text("Paid On time - Yes",style: TextStyle(color: Colors.black,fontSize: 12)) ,
                                  fit:BoxFit.contain,),
