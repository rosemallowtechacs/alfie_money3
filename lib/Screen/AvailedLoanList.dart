...
class AvailedLoanList extends StatefulWidget {
  @override
  _AvailedLoanListState createState() => _AvailedLoanListState();
}

class _AvailedLoanListState extends State<AvailedLoanList> {
...
//Text("Loans Availed"),
  ...
  Widget build(BuildContext context) {
    ...
    Text("Loan status", style: TextStyle(color: Rmlightblue, fontSize: 18, fontWeight: FontWeight.bold),)
    ),
                          ...
                          child: Container(child:Stack(children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Align(child:Container(
                                  ...
                                  children: [
                                    Container(
                                     ...
                                     gradient: LinearGradient(
                                              colors: [
                                                snapshot.data.data[index].loanStatus=="Processing"? Colors.green: Colors.white,
                                                Colors.white,
                                              ],
                                              begin: Alignment.topLeft,
                                              end: Alignment.bottomRight,
                                      ...
                                      Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            gradient: LinearGradient(
                                              colors: [
                                                snapshot.data.data[index].loanStatus=="Rejected"?Colors.red:snapshot.data.data[index].loanStatus=="Approved"? Colors.green: Colors.white,
                                                Colors.white,
                                              ],
                                              begin: Alignment.topLeft,
                                              end: Alignment.bottomRight,
                                          ...
                                          child:snapshot.data.data[index].loanStatus=="Rejected"?Text("Rejected"):Text("Approved")),
                                      Container(
                                          decoration: BoxDecoration(
                                            /* borderRadius: BorderRadius.circular(20),*/
                                            //color: Rmlightblue,
                                            ...
                                            gradient: LinearGradient(
                                              colors: [
                                                snapshot.data.data[index].loanStatus=="Disbursed"?Colors.green:Colors.white,
                                                Colors.white,
                                              ],
                                              begin: Alignment.topLeft,
                                              end: Alignment.bottomRight,
                                ...
                                FittedBox(child:Text("RM ${value.format(snapshot.data.data[index].loanAmount)??""}",style: TextStyle(color: Colors.black,fontSize: 12)) ,
                                  fit:BoxFit.contain,),
                                SizedBox(height: 5,),
                                ...
                                FittedBox(child:Text("${snapshot.data.data[index].loanStatus??""}",style: TextStyle(color: Colors.black,fontSize: 12)) ,
                                  fit:BoxFit.contain,),
                                ...
                                Align(child: GestureDetector(child:Container(
                                    ...
                                    child: FittedBox(child:Row(children: [
                                      Text("D/L contract",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold)),
                                      SizedBox(width: 20,),
                                      Card(
                                        //color: Color(0xCDA3C5EC),
                                        color: Colors.white,
